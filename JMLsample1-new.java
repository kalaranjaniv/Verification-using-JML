...
class AreaThread extends Thread {
	/*@ spec_public @*/ double radius_thread;
	/*@ spec_public @*/ double pi_thread;
	/*@ spec_public @*/ double area;
...
{  /*@ spec_public @*/ String current_time = new String();
   /*@ spec_public @*/ int h,m;
